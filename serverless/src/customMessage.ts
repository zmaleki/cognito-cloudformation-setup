exports.handle = async (event, context, callback) => {
                                ...
                                <tr>
                                  <td align="left">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td> <a href="#" target="_blank">Login Now</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-block">
                        <span class="apple-link">Company Inc, 100 Perth street, Perth WA 6000</span>
                      </td>
                    </tr>
                    <tr>
    ...
    event.response.emailSubject = "THIS IS FROM Zainab"
    callback(null, event);
}